...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../bram_ass_2.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../bram_ass_2.gen/sources_1/ip/ila_0/hdl/verilog" \
