...
#
# Script generated by Vivado on Fri Sep 29 12:41:38 IST 2023
...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/kanish/System_Design_through_FPGA/Vivado/Uart/Uart/Uart.cache/compile_simlib/modelsim"
  fi
