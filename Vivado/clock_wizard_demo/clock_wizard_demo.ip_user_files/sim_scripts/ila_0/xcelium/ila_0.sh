...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../clock_wizard_demo.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../clock_wizard_demo.gen/sources_1/ip/ila_0/hdl/verilog" \
