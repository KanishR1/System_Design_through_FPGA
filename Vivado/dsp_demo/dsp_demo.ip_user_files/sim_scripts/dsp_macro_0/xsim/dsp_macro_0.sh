...
#
# Script generated by Vivado on Sun Aug 27 12:24:10 IST 2023
...
# script info
echo -e "dsp_macro_0.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xbip_dsp48_wrapper_v3_0_4 -L xbip_utils_v3_0_10 -L xbip_pipe_v3_0_6 -L dsp_macro_v1_0_3 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dsp_macro_0 xil_defaultlib.dsp_macro_0 xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/kanish/Xilinx/Vivado/2023.1/data/xsim"
  fi
