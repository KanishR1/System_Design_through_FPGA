...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../dsp_demo.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../dsp_demo.gen/sources_1/ip/ila_0/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/kanish/System_Design_through_FPGA/Vivado/dsp_demo/dsp_demo.cache/compile_simlib/xcelium"
  fi
