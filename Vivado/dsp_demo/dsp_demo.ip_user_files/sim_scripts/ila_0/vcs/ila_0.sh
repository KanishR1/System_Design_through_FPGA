...
#
# Script generated by Vivado on Sun Aug 27 12:24:29 IST 2023
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../dsp_demo.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../dsp_demo.gen/sources_1/ip/ila_0/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/kanish/System_Design_through_FPGA/Vivado/dsp_demo/dsp_demo.cache/compile_simlib/vcs"
  fi
