...
#
# Script generated by Vivado on Fri Sep 08 10:53:29 IST 2023
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../mac_vector.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../mac_vector.gen/sources_1/ip/ila_0/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/kanish/System_Design_through_FPGA/Vivado/mac_vector/mac_vector.cache/compile_simlib/vcs"
  fi
