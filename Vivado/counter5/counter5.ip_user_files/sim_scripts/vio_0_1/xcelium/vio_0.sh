...
compile()
{
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../counter5.gen/sources_1/ip/vio_0_1/hdl/verilog" +incdir+"../../../../counter5.gen/sources_1/ip/vio_0_1/hdl" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/kanish/System_Design_through_FPGA/Vivado/counter5/counter5.cache/compile_simlib/xcelium"
  fi
