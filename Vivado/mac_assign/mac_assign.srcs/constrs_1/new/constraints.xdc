...
create_clock -period 10.750 -name clk -waveform {0.000 7.000} -add
create_clock -period 10.750 -name clk -waveform {0.000 7.000} [get_ports clk]
...
set_output_delay -clock [get_clocks clk] -min -add_delay 0.000 [get_ports {out[0]}]
set_output_delay -clock [get_clocks clk] -max -add_delay 0.000 [get_ports {out[0]}]

set_output_delay -clock [get_clocks clk] -min -add_delay 0.000 [get_ports {out[1]}]
set_output_delay -clock [get_clocks clk] -max -add_delay 0.000 [get_ports {out[1]}]

set_output_delay -clock [get_clocks clk] -min -add_delay 0.000 [get_ports {out[2]}]
set_output_delay -clock [get_clocks clk] -max -add_delay 0.000 [get_ports {out[2]}]

set_output_delay -clock [get_clocks clk] -min -add_delay 0.000 [get_ports {out[3]}]
set_output_delay -clock [get_clocks clk] -max -add_delay 0.000 [get_ports {out[3]}]

set_output_delay -clock [get_clocks clk] -min -add_delay 0.000 [get_ports {out[4]}]
set_output_delay -clock [get_clocks clk] -max -add_delay 0.000 [get_ports {out[4]}]


set_output_delay -clock [get_clocks clk] -min -add_delay 0.000 [get_ports {out[5]}]
set_output_delay -clock [get_clocks clk] -max -add_delay 0.000 [get_ports {out[5]}]

set_output_delay -clock [get_clocks clk] -min -add_delay 0.000 [get_ports {out[6]}]
set_output_delay -clock [get_clocks clk] -max -add_delay 0.000 [get_ports {out[6]}]


set_output_delay -clock [get_clocks clk] -min -add_delay 0.000 [get_ports {out[7]}]
