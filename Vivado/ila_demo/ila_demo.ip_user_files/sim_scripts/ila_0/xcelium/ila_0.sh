...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../ila_demo.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../ila_demo.gen/sources_1/ip/ila_0/hdl/verilog" \
