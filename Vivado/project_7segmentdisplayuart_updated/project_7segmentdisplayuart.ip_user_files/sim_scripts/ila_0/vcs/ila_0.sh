...
#
# Script generated by Vivado on Fri Sep 22 16:03:08 IST 2023
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../project_7segmentdisplayuart.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../project_7segmentdisplayuart.gen/sources_1/ip/ila_0/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/kanish/System_Design_through_FPGA/Vivado/project_7segmentdisplayuart_updated/project_7segmentdisplayuart.cache/compile_simlib/vcs"
  fi
