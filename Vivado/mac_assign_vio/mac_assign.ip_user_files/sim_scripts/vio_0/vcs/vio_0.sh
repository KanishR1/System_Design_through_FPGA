...
#
# Script generated by Vivado on Fri Aug 25 10:38:27 IST 2023
...
compile()
{
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../mac_assign.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../mac_assign.gen/sources_1/ip/vio_0/hdl" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/arulvignesh/System_Design_through_FPGA/Vivado/mac_assign/mac_assign.cache/compile_simlib/vcs"
  fi
