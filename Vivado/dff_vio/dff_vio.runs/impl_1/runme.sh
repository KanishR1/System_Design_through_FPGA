...
HD_PWD='/home/kanish/Vivado/dff_vio/dff_vio.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dff_vio.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dff_vio.tcl -notrace
