...
HD_PWD='/home/kanish/Vivado/dff_vio/dff_vio.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dff_vio.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dff_vio.tcl
