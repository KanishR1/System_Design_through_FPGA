...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../mac_vio_ila.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../mac_vio_ila.gen/sources_1/ip/ila_0/hdl/verilog" \
