...
#
# Script generated by Vivado on Wed Oct 11 14:29:42 IST 2023
...
compile()
{
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../pr_demo.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../pr_demo.gen/sources_1/ip/vio_0/hdl" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/kanish/System_Design_through_FPGA/Vivado/pr_demo/pr_demo.cache/compile_simlib/vcs"
  fi
