...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../bram_assignment.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../bram_assignment.gen/sources_1/ip/ila_0/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/kanish/System_Design_through_FPGA/Vivado/bram_assignment/bram_assignment.cache/compile_simlib/xcelium"
  fi
