...
#
# Script generated by Vivado on Fri Sep 01 10:39:50 IST 2023
...
# script info
echo -e "ila_0.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../bram_assignment.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../bram_assignment.gen/sources_1/ip/ila_0/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/kanish/System_Design_through_FPGA/Vivado/bram_assignment/bram_assignment.cache/compile_simlib/vcs"
  fi
