...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../bram_task_1.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../bram_task_1.gen/sources_1/ip/vio_0/hdl" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../bram_task_1.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../bram_task_1.gen/sources_1/ip/vio_0/hdl" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/kanish/System_Design_through_FPGA/Vivado/bram_task_1/bram_task_1.cache/compile_simlib/xcelium"
  fi
