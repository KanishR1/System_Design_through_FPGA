...
#
# Script generated by Vivado on Thu Aug 31 22:11:11 IST 2023
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../bram_task_1.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../bram_task_1.gen/sources_1/ip/vio_0/hdl" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../bram_task_1.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../bram_task_1.gen/sources_1/ip/vio_0/hdl" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/kanish/System_Design_through_FPGA/Vivado/bram_task_1/bram_task_1.cache/compile_simlib/vcs"
  fi
